...
deb https://archive.ubuntu.com/ubuntu/packages jammy main restricted
# deb-src https://archive.ubuntu.com/ubuntu/packages jammy main restricted

## Major bug fix updates produced after the final release of the
## distribution.
deb https://archive.ubuntu.com/ubuntu/packages jammy-updates main restricted
# deb-src https://archive.ubuntu.com/ubuntu/packages jammy-updates main restricted

## N.B. software from this repository is ENTIRELY UNSUPPORTED by the Ubuntu
## team. Also, please note that software in universe WILL NOT receive any
## review or updates from the Ubuntu security team.
deb https://archive.ubuntu.com/ubuntu/packages jammy universe
# deb-src https://archive.ubuntu.com/ubuntu/packages jammy universe
deb https://archive.ubuntu.com/ubuntu/packages jammy-updates universe
# deb-src https://archive.ubuntu.com/ubuntu/packages jammy-updates universe
...
## security team.
deb https://archive.ubuntu.com/ubuntu/packages jammy multiverse
# deb-src https://archive.ubuntu.com/ubuntu/packages jammy multiverse
deb https://archive.ubuntu.com/ubuntu/packages jammy-updates multiverse
# deb-src https://archive.ubuntu.com/ubuntu/packages jammy-updates multiverse
...
deb https://archive.ubuntu.com/ubuntu/packages jammy-backports main restricted universe multiverse
# deb-src https://archive.ubuntu.com/ubuntu/packages jammy-backports main restricted universe multiverse

deb https://archive.ubuntu.com/ubuntu/security jammy-security main restricted
# deb-src https://archive.ubuntu.com/ubuntu/security jammy-security main restricted
deb https://archive.ubuntu.com/ubuntu/security jammy-security universe
# deb-src https://archive.ubuntu.com/ubuntu/security jammy-security universe
deb https://archive.ubuntu.com/ubuntu/security jammy-security multiverse
# deb-src https://archive.ubuntu.com/ubuntu/security jammy-security multiverse
